...
<%-- 		        <c:if test="${.atchFileSn!=null}"> --%>
	            ...
	            <td>
		            <span>
			            </span><input type="file" id="uploadFile" name="uploadFile" multiple />
<!-- 			            <button type="button" class="btn" onclick="delete()"">삭제</button> -->
		            </span>
    ...
    filesArr.forEach(function (fArr) {
      ...
      reader.onload = function (e) {
        ...
        $('#atchfileChange').append(
       		...
       		+ '<font style="font-size:12px">' + fArr.name + '</font>'  
       		+ '<div/>'
		);
